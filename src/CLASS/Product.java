...
public class Product {
    ...
    public static void insertProduct(Product product)
    {
        ...
        try {
            ...
            if(ps.executeUpdate() != 0){
                JOptionPane.showMessageDialog(null, "NOWY PRODUKT ZOSTAL DODANY");
    ...
    // zaktualizuj produkt
    // changeImage aktualizacja obrazu produktu
    ...
    public static void deleteProduct(Integer id)
    {
        ...
        try {
            ...
            // komunikat przed usunieciem produktu
            int YesOrNo = JOptionPane.showConfirmDialog(null,"CZY NA PEWNO CHCESZ USUNAC PRODUKT?","USUWANIE PRODUKTU", JOptionPane.YES_NO_OPTION);
            if(YesOrNo == 0){
                
                if(ps.executeUpdate() != 0){
                JOptionPane.showMessageDialog(null, "PRODUKT USUNIETY");
     ...
     // pobierz listę produktów za pomocą arraylist
...
"LIKE ?;";
        ...
        try {
            ...
            Product prd;
            // Integer ID, String NAZWA, Integer CATEGORY_ID, String CENA, byte[] OBRAZ, Liczba całkowita ILOŚĆ, String OPIS
            while(rs.next()){
