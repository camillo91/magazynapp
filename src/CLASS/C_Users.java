   ...
   public C_Users(){}
     ...
     public static void insertUser(C_Users user)
    {
        ...
        try {
            ...
            ps.setString(3, "user");// admin moze dodać użytkownika
            ...
            if(ps.executeUpdate() != 0){
                JOptionPane.showMessageDialog(null, "NOWY UZYTKOWNIK DODANY!");
    ...
    public static void updateUser(C_Users user)
    {
        ...
        try {
            ...
            if(ps.executeUpdate() != 0){
                JOptionPane.showMessageDialog(null, "UZYTKOWNIK ZAKTUALIZOWANY");
    ...
    public static void deleteUser(Integer userId)
    {
        ...
        try {
            ...
            // komunikat usuniecia uzytkownika
            int YesOrNo = JOptionPane.showConfirmDialog(null,"CZY NA PEWNO CHCESZ USUNAC UZYTKOWNIKA?","USUN UZYTKOWNIKA", JOptionPane.YES_NO_OPTION);
            if(YesOrNo == 0){
               
                if(ps.executeUpdate() != 0){
                   
                    JOptionPane.showMessageDialog(null, "UZYTKOWNIK USUNIETY");
                }
                else{
                    JOptionPane.showMessageDialog(null, "COS POSZLO NIE TAK");
                }
